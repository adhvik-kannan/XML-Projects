...
public class Lab3 {
	...
	public static ArrayList createArrayListOfBitSets(String filePath, XMLReader xml, String selement, String tagName1, String tagName2) throws ParserConfigurationException, SAXException, IOException {
		BitSet bits = null;
		...
		for(int s=0; s<nodeList.getLength(); s++) {
			...
			bits = toBitSet(binary);
			String character = extract(node, tagName2);
			if(bitSetList.contains(bits)) continue;
			bitSetList.add(bits);
			list.add(character);
	...
	public static ArrayList createArrayListOfCharacters(String filePath, XMLReader xml, String selement, String tagName1, String tagName2) throws ParserConfigurationException, SAXException, IOException {
		BitSet bits = null;
		ArrayList bitSetList = new ArrayList();
		ArrayList list = new ArrayList();
		Document file = xml.ReadXML(filePath);
